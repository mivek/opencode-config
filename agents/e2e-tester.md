...
permission:
  ...
  bash:
    "snip ls *": "allow"
    "snip cat *": "allow"
    "snip npx playwright --version": "allow"
    "snip npx playwright test*": "allow"
    "snip npx playwright codegen*": "allow"
    "snip npx playwright show-report*": "allow"
    "snip npx playwright show-trace*": "allow"
    "snip pnpm exec playwright test*": "allow"
    "snip pnpm exec playwright codegen*": "allow"
    "snip npx playwright install*": "ask"
    "*": "deny"
---
