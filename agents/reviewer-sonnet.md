---
description: Premium reviewer backed by Claude Sonnet 4.6. Use for non-trivial diffs, security-sensitive code, or complex refactors. Costs real money per invocation. Same output format as the default reviewer.
mode: subagent
